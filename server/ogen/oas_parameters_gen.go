...
// TodoIDDeleteParams is parameters of DELETE /todo/{id} operation.
type TodoIDDeleteParams struct {
	ID int
}

func unpackTodoIDDeleteParams(packed middleware.Parameters) (params TodoIDDeleteParams) {
	{
...
func decodeTodoIDDeleteParams(args [1]string, argsEscaped bool, r *http.Request) (params TodoIDDeleteParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param := args[0]
		if argsEscaped {
...
// TodoIDPutParams is parameters of PUT /todo/{id} operation.
type TodoIDPutParams struct {
	ID int
}

func unpackTodoIDPutParams(packed middleware.Parameters) (params TodoIDPutParams) {
	{
		key := middleware.ParameterKey{
			Name: "id",
			In:   "path",
...
func decodeTodoIDPutParams(args [1]string, argsEscaped bool, r *http.Request) (params TodoIDPutParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param := args[0]
		if argsEscaped {
